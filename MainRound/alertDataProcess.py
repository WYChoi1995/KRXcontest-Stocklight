...
investAlertData = {"InvestCaution": process_alert_data("./csvData/investCaution.csv", AlertLevel.CAUTION),
                   "InvestWarning": process_alert_data("./csvData/investWarning.csv", AlertLevel.WARNING),
                   "InvestDanger": process_alert_data("./csvData/investDanger.csv", AlertLevel.DANGER)}
